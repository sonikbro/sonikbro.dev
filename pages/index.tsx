  ...
  return (
    <>
      ...
      <p className="mb-[1.2em] text-[1.3em]">
        👨‍💻 I have been working in web development for over 3 years and have extensive experience using technologies such as React, Redux, TypeScript, and many others web technologies.
      </p>
